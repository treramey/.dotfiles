...
```
/pr-walkthrough https://github.com/org/repo/pull/42
/pr-walkthrough https://gitlab.example.com/team/project/-/merge_requests/13 assume i don't know zig or git internals
/pr-walkthrough https://github.com/org/repo/pull/99 this is for a design review with the infra team, focus on the database migration risks
/pr-walkthrough https://github.com/org/repo/pull/7 the audience is frontend engineers who haven't seen the backend before
```
